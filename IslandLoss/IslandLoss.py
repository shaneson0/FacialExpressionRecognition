...
from generateData import getData2, Reverse
...
Loss = model_centerloss.evaluate([X_test, y_test_onehot_lablels], [y_test_onehot_lablels, y_valid_origin_centers], verbose=1)
print('Loss: ', Loss)
